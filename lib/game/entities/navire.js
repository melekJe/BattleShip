ig.module( 'game.entities.navire' )
...
.defines(function() {
    ...
    EntityNavire = ig.Entity.extend({
        
        animSheet: new ig.AnimationSheet( 'media/navire.png', 72, 24 ),
        size : {x: 72, y: 24},
    ...
    update: function()
      {
        ...
        ig.global.navire_y = Math.floor(this.pos.x / 24);
        ig.global.navire_x  = Math.floor(this.pos.y / 24);
